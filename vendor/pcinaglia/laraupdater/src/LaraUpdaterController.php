...
class LaraUpdaterController extends Controller
{
    ...
    {
        echo '<head><link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"></head><body class="mt-3"><div class="container">';

        echo '<h2>' . trans('laraupdater.LaraUpdater') . '</h2><hr>';
